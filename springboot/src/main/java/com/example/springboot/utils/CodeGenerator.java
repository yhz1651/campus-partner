...
public class CodeGenerator {
    ...
    private static final String TABLE = "relation";  // 表名
    private static final String MODULE_NAME = "关注";  // 菜单名称
    private static final String PACKAGE_NAME = "com.example.springboot";  // java代码的包名
    private static final String AUTHOR = "yhz";   // 作者
    ...
    private static String getVueTableBody(List<TableColumn> tableColumnList) {
        ...
        for (TableColumn tableColumn : tableColumnList) {
            ...
            if (tableColumn.getColumnName().endsWith("img")) {
                ...
                builder.append(SPACE6).append("<el-table-column label=\"" + tableColumn.getColumnComment() + "\"><template #default=\"scope\"><el-button type=\"primary\"><a :href=\"scope.row.").append(camelCaseName).append("\" target=\"_blank\" style=\"text-decoration: none; color: white\">点击下载</a></el-button></template></el-table-column>\n");
