...
<template>
  <div style="width: 50%; margin: auto;" >
    <el-card style="min-height: calc(100vh - 100px);">
      <div style="font-size: 20px; font-weight: bold; color: orange; margin: 20px 0 20px 30px">
        修改密码
      </div>
      <el-form style="width: 60%; margin: 30px auto" label-width="110px" :model="state.form" :rules="rules" ref="ruleFormRef" >
