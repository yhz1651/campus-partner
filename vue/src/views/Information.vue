...
const confirmDelBatch = () => {
  ...
  request.post('/information/del/batch', idArr).then(res => {
    if (res.code === '200') {
...
// 导出接口
const exportData = () => {
  window.open(`http://${config.serverUrl}/information/export`)
}
...
<template>
  <div>
    ...
    <div style="margin: 10px 0">
      <el-button type="success" @click="handleAdd" v-if="auths.includes('information.add')">
        <el-icon style="vertical-align: middle">
          <Plus/>
        </el-icon>
      ...
      <el-upload
          v-if="auths.includes('information.import')"
          class="ml5"
          :show-file-list="false"
          style="display: inline-block; position: relative; top: 3px"
          :action='`http://${config.serverUrl}/information/import`'
      ...
      <el-button type="primary" @click="exportData" class="ml5" v-if="auths.includes('information.export')">
        <el-icon style="vertical-align: middle">
          <Top/>
        </el-icon>
        <span style="vertical-align: middle"> 导出 </span>
      </el-button>
      <el-popconfirm title="您确定删除吗？" @confirm="confirmDelBatch" v-if="auths.includes('information.deleteBatch')">
        <template #reference>
    ...
    <div style="margin: 10px 0">
      <el-table :data="state.tableData" stripe border @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" width="180">
          <template #default="scope">
            <el-button type="primary" @click="handleEdit(scope.row)" v-if="auths.includes('information.edit')">编辑
            </el-button>
            <el-popconfirm title="您确定删除吗？" @confirm="del(scope.row.id)"
                           v-if="auths.includes('information.delete')">
              <template #reference>
    ...
    <el-dialog v-model="dialogFormVisible" title="资讯信息" width="40%">
      <el-form ref="ruleFormRef" :rules="rules" :model="state.form" label-width="80px" style="padding: 0 20px"
        ...
        <el-form-item prop="file" label="公告附件">
        ...
        <!--        </el-form-item>-->
        <!--        <el-form-item prop="view" label="浏览量">-->
        <!--          <el-input v-model="state.form.view" autocomplete="off"></el-input>-->
        <!--        </el-form-item>-->
