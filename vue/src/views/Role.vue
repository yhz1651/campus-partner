...
<template>
  <div>
    <div>
      <el-input v-model="name" placeholder="请输入角色名称" class="w300" />
    ...
    <div style="margin: 10px 0">
      ...
      <el-popconfirm title="您确定删除吗？" @confirm="confirmDelBatch"  v-if="auths.includes('role.deleteBatch')">
        <template #reference>
      ...
      <el-table :data="state.tableData" stripe border  @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" width="180">
          <template #default="scope">
            <el-button type="primary" @click="handleEdit(scope.row)"  v-if="auths.includes('role.edit')">编辑</el-button>
            <el-popconfirm title="您确定删除吗？" @confirm="del(scope.row.id)"  v-if="auths.includes('role.delete')">
              <template #reference>
    ...
    <el-dialog v-model="dialogFormVisible" title="角色信息" width="40%">
